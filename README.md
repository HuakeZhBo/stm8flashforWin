stm8flash for Windows compile with MSVC

this project is migrate from vdudouyt/stm8flash to using VS2022 Community,
and delete the support of espstlink.

belows are origin readme:
